...
import org.asyncwave.currencyreader.rupees.classification.env.BorderedText;
...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  protected int getLayoutId() {
    return R.layout.cr_aw_ic_camera_connection_fragment;
  }
  ...
  private void recreateClassifier(Classifier.Model model, Classifier.Device device, int numThreads) {
    ...
    if (device == Classifier.Device.GPU
      ...
      runOnUiThread(
          () -> {
            Toast.makeText(this, R.string.cr_aw_ic_gpu_quant_error, Toast.LENGTH_LONG).show();
          });
      return;
    }
    try {
