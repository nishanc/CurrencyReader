...
<p align="center"><b>
Based on <a href="https://tensorflow.org/lite">TensorFlow Lite</a>
for Android.</b>
</p>

This application uses
[Image classification](https://www.tensorflow.org/lite/models/image_classification/overview)
to continuously classify currency (Sri Lankan Rupees) from the device's back camera.
...
```
git clone https://github.com/nishanc/CurrencyReader
```

Open the CurrencyReader in Android Studio. To do this, open Android
...
To test the app, open the app called `Currency Reader` on your device. When you run
the app the first time, the app will request permission to access the camera.
Re-installing the app may require you to uninstall the previous installations.

## Assets folder
_Do not delete the assets folder content_. If you explicitly deleted the
files, it contains the trained model for classifying currency notes.